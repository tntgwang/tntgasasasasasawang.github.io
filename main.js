...
/* harmony import */ var src_x_http_http_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/x/http/http.service */ "./src/x/http/http.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                ng_snotify__WEBPACK_IMPORTED_MODULE_2__["SnotifyService"],
                {
                    ...
                    useClass: src_x_http_http_service__WEBPACK_IMPORTED_MODULE_9__["HttpErrorService"],
                    multi: true
                },
                {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HTTP_INTERCEPTORS"],
                    useClass: src_x_http_http_service__WEBPACK_IMPORTED_MODULE_9__["AuthHttpService"],
                    multi: true
                }
            ],
            exports: [
                ng_snotify__WEBPACK_IMPORTED_MODULE_2__["SnotifyModule"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_4__["FooterComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_5__["HeaderComponent"],
            ]
        })
    ], CoreModule);
    return CoreModule;
...
var HttpService = /** @class */ (function () {
    function HttpService(http, toastService, spinner) {
        this.http = http;
...
var HttpErrorService = /** @class */ (function () {
    function HttpErrorService(toastService, spinner) {
        this.toastService = toastService;
        this.spinner = spinner;
    }
...
module.exports = __webpack_require__(/*! /Users/nguyenquang/Documents/angular/master/src/main.ts */"./src/main.ts");
